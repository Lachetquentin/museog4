...
namespace Museo
{
    public partial class FrmViewExhibition : Form
    {
        private int exhibitionId;
        private Exhibition exhibition;
        private int selectedMasterpieceId;

        public FrmViewExhibition(int selectedExhibitionId)
        {
            InitializeComponent();
        ...
        private void FrmViewExhibition_Load(object sender, EventArgs e)
        {
            lblTitle.Text = "Liste des oeuvres de l'exposition : " + exhibition.Name;
            dgvMasterpieces.DataSource = DataLayer.MasterpieceData.GetListOfMasterpiecesByExhibitionId(exhibitionId);
            GridSetup();
        }
